...
if __name__ == '__main__':
    try:
        Emailer.setCredentials(
            symmetric_key=os.getenv('PH_VARIANTX_EMAILER_LOGIN_SYMMETRIC_KEY').encode(),
            login_email=os.getenv('PH_VARIANTX_EMAILER_LOGIN_EMAIL').encode(),
            login_password=os.getenv('PH_VARIANTX_EMAILER_LOGIN_PASSWORD').encode(),
            smtp_server=os.getenv('PH_VARIANTX_EMAILER_SMTP_SERVER').encode(),
            smtp_port=os.getenv('PH_VARIANTX_EMAILER_SMTP_PORT').encode()
        )
